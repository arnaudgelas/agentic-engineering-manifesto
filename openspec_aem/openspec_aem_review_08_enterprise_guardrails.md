# OpenSpec Review — Part 14: Enterprise Guardrail Domain Coverage
...
- `regulatory/incidents-appendix.md`
...
| Domain | Specify | Design | Plan | Execute | Verify | Validate | Release | Operate | Learn / Govern |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 14.1 Governance | Critical | High | High | Critical | High | High | Critical | High | Critical |
| 14.2 Architectural | High | Critical | High | High | Medium | Medium | High | Medium | Medium |
| 14.3 Specification & demand | Critical | High | High | Medium | High | Critical | Medium | Low | Medium |
| 14.4 Autonomy & agency | Critical | High | High | Critical | High | High | Critical | High | High |
| 14.5 Tools & execution | Medium | High | High | Critical | High | Medium | High | Critical | Medium |
| 14.6 Data & privacy | Critical | High | Medium | Critical | High | High | Critical | High | High |
| 14.7 DevSecOps | Medium | High | High | Critical | Critical | High | Critical | High | High |
| 14.8 Supply-chain | High | Critical | High | High | High | Medium | Critical | High | High |
| 14.9 V&V & evidence | High | High | High | Critical | Critical | Critical | Critical | High | High |
| 14.10 Release & deployment | Medium | Medium | High | High | High | High | Critical | Critical | High |
| 14.11 Operational resilience | Low | High | Medium | Medium | Medium | Medium | High | Critical | Critical |
| 14.12 FinOps & economics | High | High | Critical | Critical | Medium | Medium | High | High | High |
| 14.13 Human guardrails | High | High | Medium | Medium | High | Critical | Critical | High | High |
| 14.14 Legal & compliance | Critical | High | Medium | High | High | Critical | Critical | High | High |
| 14.15 Learning & memory | Medium | Medium | Medium | High | High | High | Medium | High | Critical |

#### OpenSpec Coverage matrix

| Domain | Specify | Design | Plan | Execute | Verify | Validate | Release | Operate | Learn / Govern |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 14.1 Governance | Absent | Absent | Absent | Absent | Instruction | Absent | Absent | Absent | Absent |
| 14.2 Architectural | Instruction | Instruction | Instruction | Absent | Instruction | Absent | Absent | Absent | Absent |
| 14.3 Specification & demand | Instruction | Instruction | Instruction | Absent | Instruction | Absent | Absent | Absent | Absent |
| 14.4 Autonomy & agency | Absent | Absent | Absent | Absent | Absent | Absent | Instruction | Absent | Absent |
| 14.5 Tools & execution | Absent | Absent | Absent | Absent | Absent | Absent | Instruction | Absent | Absent |
| 14.6 Data & privacy | Absent | Absent | Absent | Instruction | Instruction | Absent | Absent | Absent | Absent |
| 14.7 DevSecOps | Absent | Absent | Absent | Instruction | Instruction | Absent | Absent | Absent | Absent |
| 14.8 Supply-chain | Instruction | Instruction | Absent | Instruction | Absent | Absent | Absent | Absent | Absent |
| 14.9 V&V & evidence | Instruction | Instruction | Instruction | Absent | Instruction | Absent | Instruction | Absent | Absent |
| 14.10 Release & deployment | Absent | Instruction | Absent | Absent | Absent | Absent | Instruction | Absent | Absent |
| 14.11 Operational resilience | Absent | Absent | Absent | Absent | Absent | Absent | Absent | Instruction | Absent |
| 14.12 FinOps & economics | Absent | Instruction | Absent | Absent | Absent | Absent | Absent | Absent | Absent |
| 14.13 Human guardrails | Absent | Absent | Absent | Absent | Instruction | Absent | Instruction | Absent | Absent |
| 14.14 Legal & compliance | Absent | Absent | Absent | Instruction | Instruction | Absent | Absent | Absent | Absent |
| 14.15 Learning & memory | Instruction | Instruction | Absent | Instruction | Absent | Absent | Instruction | Absent | Instruction |

#### Critical/High gaps

1. **Governance — Specify (Critical).** OpenSpec captures no accountable human owner or risk tier at specification entry. Severity: Critical. Evidence: `openspec_aem/openspec_aem_review_08a_domains.md` §14.1 "Accountable human owner — Absent" rows. Allianz workflow: Solvency II Art. 112–127 internal model change governance per `domains/insurance.md` line 51 requires named owner before any change is queued for supervisory approval; without an owner field, an agent-driven SCR-model change cannot be filed in the model-change register required by `regulatory/incidents-appendix.md` Knight Capital-class operational-loss precedent.
2. **Governance — Release (Critical).** No release decision record, segregation of duties, or kill switch. Severity: Critical. Evidence: `openspec_aem/openspec_aem_review_08a_domains.md` §14.1 "Segregation of duties — Absent" and §14.10 "Release approver — Absent". Allianz workflow: claims-fraud-rules deployment under Solvency II ORSA must be authorised by a person distinct from the implementer; OpenSpec's `--yes` flag (`OpenSpec/openspec/specs/cli-archive/spec.md` line 12) collapses author and approver into one identity, breaking the four-eyes principle required by `domains/insurance.md` line 94 actuarial-function independence.
3. **Autonomy & agency — Execute (Critical).** No tier classification, prohibited-actions list, or insurance-specific tier cap. Severity: Critical. Evidence: `openspec_aem/openspec_aem_review_08a_domains.md` §14.4 Domain Coverage Score 10/100. Allianz workflow: personal-lines underwriting decisioning is capped at Tier 1 (observe only) per `domains/insurance.md` line 263; OpenSpec has no field to declare or enforce that cap, so an agent generating production underwriting code cannot be machine-prevented from a Tier 3 commit.
4. **Tools & execution — Execute (Critical).** No tool allowlist, environment isolation, tool-call logging, or dangerous-command blocking. Severity: Critical. Evidence: `openspec_aem/openspec_aem_review_08a_domains.md` §14.5 Domain Coverage Score 12/100. Allianz workflow: agent-authored changes against the policy-administration system require an MCP allowlist that excludes write-paths to the policy-master database; without `allowed_tools`, the change cannot be tied to an `agent-inventory.json` per `operational-templates/agent-inventory-schema.md`.
5. **Data & privacy — Specify (Critical).** No data classification field; GDPR Art. 9 special-category data cannot be tagged. Severity: Critical. Evidence: `openspec_aem/openspec_aem_review_08a_domains.md` §14.6. Allianz workflow: health and genetic data ingested by life/health underwriting models per `domains/insurance.md` line 208 must be tagged at intake to prevent unlawful processing under GDPR Art. 9; without classification, the evidence required by EU AI Act Art. 10 data-governance for high-risk AI systems is missing.
6. **Data & privacy — Release (Critical).** No residency control; PostHog telemetry leaves the EEA by default. Severity: Critical. Evidence: §14.6 Cross-border transfer row + §14.14 Cross-border transfer row. Allianz workflow: data-protection-impact-assessment for AI-driven claims triage requires residency proof per GDPR Chapter V (`domains/insurance.md` line 233); telemetry to a US-domiciled service violates the assessment without operator override.
7. **DevSecOps — Verify (Critical).** No SAST/SCA/secrets-scanning gate, no provenance attestation, no independent reviewer. Severity: Critical. Evidence: §14.7 Domain Coverage Score 14/100. Allianz workflow: pre-production gate for the open-banking PSD2 strong-customer-authentication module per `domains/insurance.md` requires a release attestation conforming to `governance/evidence-bundle-schema.md` line 51 `bundle_hash`; OpenSpec emits no such attestation.
8. **Supply-chain — Design (Critical).** No approved-model registry; the README recommends models without DORA Pillar 4 third-party register entries. Severity: Critical. Evidence: §14.8. Allianz workflow: foundation-model usage in claims-letter generation must be entered in the DORA Art. 28 third-party register per `regulatory/foundation-model-third-party-register.md`; OpenSpec's `OpenSpec/README.md` line 160 recommendation bypasses that register.
9. **V&V & evidence — Validate (Critical).** No business-metric mapping or domain-owner validation; `/opsx:verify` collapses verify+validate into one self-check. Severity: Critical. Evidence: §14.9. Allianz workflow: SCR internal-model change validation must be reviewed by a domain owner distinct from the implementer per Solvency II Art. 48 actuarial-function independence (`domains/insurance.md` line 94); OpenSpec has no separate validation artefact.
10. **Release & deployment — Release (Critical).** No release decision record, rollback test, separation of duties, or compliance artefacts. Severity: Critical. Evidence: §14.10. Allianz workflow: Solvency II major-vs-minor change classification (`domains/insurance.md` lines 77–87) demands supervisory pre-approval for major changes; `openspec archive` is a documentation event, not a release decision.
11. **Operational resilience — Operate (Critical).** No service owner, runbook, SLO, alerting, drift detection, or DR plan. Severity: Critical. Evidence: §14.11. Allianz workflow: DORA Art. 17 ICT-related-incident-management requires named service owners and tested recovery paths; OpenSpec records none of this.
12. **Human guardrails — Validate (Critical).** No anti-rubber-stamping detection, no certification before approval rights, single non-tiered prompt. Severity: Critical. Evidence: §14.13. Allianz workflow: SR 11-7 §V "effective challenge" requires a qualified independent reviewer for actuarial-model changes; the `--yes` flag is an automated rubber-stamp surface incompatible with effective challenge.
13. **Legal & compliance — Validate (Critical).** No regulatory classification, no explainability per EU AI Act Art. 13/14, no third-party model terms verification. Severity: Critical. Evidence: §14.14. Allianz workflow: high-risk AI systems for insurance pricing under EU AI Act Annex III require Art. 13 transparency and Art. 14 human-oversight artefacts; OpenSpec captures none.

### 14.17 Twelve Non-Negotiable Guardrails

| # | Non-negotiable | Rule | OpenSpec Coverage (verbatim evidence + path) | Enforcement Level | Severity of Gap |
| --- | --- | --- | --- | --- | --- |
| 1 | No unowned agent or task | Every agent, run, task, release, and waiver has a named accountable human. | `OpenSpec/openspec/specs/workspace-links/spec.md` lines 269–271: `OpenSpec SHALL not ask for owner or handoff metadata` (lifted from `openspec_aem/openspec_aem_review_08a_domains.md` §14.1 "Accountable human owner" row and §14.3 "Human owner" row). The framework explicitly declines to record an owner. | Absent | Critical |
| 2 | No agentic execution without ready spec | Entry requires acceptance criteria, risk tier, data classification, owner, out-of-scope, Definition of Done. | `OpenSpec/openspec/specs/cli-validate/spec.md` "Missing required sections" requires `## Why, ## What Changes` only (lifted from `openspec_aem/openspec_aem_review_08a_domains.md` §14.3 Block-entry rule). risk_tier Absent, data_classification Absent, accountable_owner Absent, definition_of_done Instruction. | Instruction | Critical |
| 3 | No unbounded autonomy | Every agent run has approved tier, tool scope, environment scope, expiry. | Lifted from `openspec_aem/openspec_aem_review_08a_domains.md` §14.4: "Tier classification per task — Absent". `OpenSpec/AGENTS.md` is a 1-line file; no tier, scope, or expiry fields exist in any spec. | Absent | Critical |
| 4 | No unapproved tool or MCP access | Tools are allowlisted, logged, least-privilege, revocable. | Lifted from `openspec_aem/openspec_aem_review_08a_domains.md` §14.5: "Tool allowlist — Absent", "Tool-call logging — Absent". No `allowed_tools` per `operational-templates/agent-inventory-schema.md`. | Absent | Critical |
| 5 | No architecture violation without ADR and waiver | Enterprise architecture standards enforced before merge/release. | Lifted from `openspec_aem/openspec_aem_review_08a_domains.md` §14.2: `design.md` ADR is optional per `OpenSpec/openspec/specs/opsx-verify-skill/spec.md` "No design.md" scenario lines 96–100. No waiver artefact. | Instruction | Critical |
| 6 | No secret or restricted data leakage | Sensitive-data controls cover prompts, context, outputs, logs, memory, tools. | Lifted from `openspec_aem/openspec_aem_review_08a_domains.md` §14.6: `OpenSpec/openspec/specs/cli-feedback/spec.md` line 167 redacts `API keys, tokens, secrets with <redacted>` only on the feedback path. No general PII/PHI detector; GDPR Art. 9 special-category data cannot be tagged. | Instruction | Critical |
| 7 | No generated change without tests | Agent-generated code/config requires relevant tests and regression evidence. | Lifted from `openspec_aem/openspec_aem_review_08a_domains.md` §14.7: `OpenSpec/openspec/specs/opsx-verify-skill/spec.md` "Scenario coverage check" line 63 emits a WARNING that `Does not block archive` per `OpenSpec/docs/commands.md`. | Instruction | High |
| 8 | No release without evidence bundle | Release requires trace, tests, security scans, policy checks, rollback, sign-off. | Lifted from `openspec_aem/openspec_aem_review_08a_domains.md` §14.9 and §14.10: `OpenSpec/openspec/specs/cli-archive/spec.md` "Performing archive" steps 1–5 archive Markdown only. No `release_decision_record` per `governance/evidence-bundle-schema.md`. | Absent | Critical |
| 9 | No critical/high security issue without resolution or waiver | Critical/High findings block release unless formally waived. | Lifted from `openspec_aem/openspec_aem_review_08a_domains.md` §14.7: `suppresses_security_findings_without_waiver — Absent`; no SAST/SCA gate. | Absent | Critical |
| 10 | No production change without tested rollback | Rollback tested in representative environment. | Lifted from `openspec_aem/openspec_aem_review_08a_domains.md` §14.10 and §14.11: `OpenSpec/openspec/specs/rules-injection/spec.md` line 32 injects `Include rollback plan` as prompt prose only; no rollback-test artefact. | Instruction | Critical |
| 11 | No runaway cost | Every run has budget limits, routing policy, retry limits, cost attribution. | Lifted from `openspec_aem/openspec_aem_review_08a_domains.md` §14.12: "Budget per task/workflow — Absent", "Retry budget — Absent", "Tool-call budget — Absent". `OpenSpec/README.md` line 160 recommends the most-expensive model tier. | Absent | High |
| 12 | No human rubber-stamp | High-risk approvals require qualified humans, evidence review, anti-rubber-stamping detection. | Lifted from `openspec_aem/openspec_aem_review_08a_domains.md` §14.13: `OpenSpec/openspec/specs/cli-archive/spec.md` line 12 `--yes Skip confirmation prompts (for automation)` is the canonical rubber-stamp path; no anti-rubber-stamping signals. | Absent | Critical |

**Coverage:** 0/12 (0%) — Severity per `prompt.md`: Critical. **Partial coverage of an individual non-negotiable counts as 0 for the N/12 formula.** All twelve rows score either Absent or Instruction; none reach Infrastructure-level enforcement.

### 14.18 Agent Card / Task Card Schema Verification

#### 14.18.1 Agent Card field coverage

| Field | Present in OpenSpec | Verbatim evidence with path | Gap |
| --- | --- | --- | --- |
| agent_id | No | No agent registry exists in OpenSpec; `OpenSpec/AGENTS.md` is a 1-line file (`spec-driven`) | No identifier for the agent |
| version (semver) | No | `OpenSpec/openspec/specs/openspec-conventions/spec.md` defines spec versioning, not agent versioning | No agent version tracking |
| purpose | No | No agent-purpose declaration anywhere in `OpenSpec/openspec/specs/` | Missing |
| accountable_owner | No | `OpenSpec/openspec/specs/workspace-links/spec.md` line 271: `OpenSpec SHALL not ask for owner or handoff metadata` | Explicit decline |
| steward | No | No steward field | Missing |
| allowed_autonomy_tiers | No | No tier construct anywhere in `OpenSpec/openspec/specs/` (lifted from §14.4) | Missing |
| allowed_inputs | No | No input scope on changes | Missing |
| forbidden_inputs | No | No prohibited-inputs list | Missing |
| allowed_tools | No | No allowlist; lifted from §14.5 "Tool allowlist — Absent" | Missing |
| forbidden_tools | No | No denylist | Missing |
| data_access (classification_max, retention) | No | No classification field per §14.6; `OpenSpec/openspec/specs/cli-archive/spec.md` retains indefinitely | Missing |
| required_logs (prompts, context_refs, tool_calls, outputs, policy_verdicts, human_approvals) | No | `governance/integrated-audit-trail.md` line 13 "AEM execution trace" has no counterpart in OpenSpec | Missing |
| kill_switch (owner, tested_frequency) | No | No kill switch in `OpenSpec/openspec/specs/` | Missing |
| evaluation (required_eval_suite, minimum_pass_rate, adversarial_tests_required) | No | `OpenSpec/openspec/specs/opsx-verify-skill/spec.md` "Scenario coverage check" emits prose WARNING only; no eval suite | Missing |

**Agent Card fields present:** 0/14.

#### 14.18.2 Task Card field coverage

| Field | Present in OpenSpec | Verbatim evidence with path | Gap |
| --- | --- | --- | --- |
| task_id | Partial | `OpenSpec/openspec/specs/change-creation/spec.md` defines a change folder name as identifier; tasks live in `tasks.md` per `OpenSpec/openspec/specs/openspec-conventions/spec.md` | Folder name is not a structured task_id |
| requester | No | No requester field | Missing |
| accountable_owner | No | `OpenSpec/openspec/specs/workspace-links/spec.md` line 271 declines owner | Explicit decline |
| business_need | Partial | `OpenSpec/docs/concepts.md` line 372: `## Intent / Users have requested a dark mode option to reduce eye strain` — Markdown prose | Prose only, not structured |
| success_metric | No | No measurable-value field per §14.3 | Missing |
| acceptance_criteria | Partial | `OpenSpec/docs/concepts.md` line 219 `### Requirement: ... SHALL ...` and lines 257–260 scenarios | Prose, not machine-checkable |
| out_of_scope | Partial | `OpenSpec/docs/concepts.md` lines 376–381 out-of-scope example pattern | Pattern only, no validator rule |
| risk_tier | No | No risk_tier field per §14.3 | Missing |
| blast_radius | No | No blast-radius field | Missing |
| data_classification | No | No data-classification field per §14.6 | Missing |
| autonomy_tier | No | No tier field per §14.4 | Missing |
| allowed_repositories | No | `OpenSpec/openspec/specs/workspace-foundation/spec.md` line 196 keeps repo ownership legible — coordination only, not enforcement | Coordination only |
| allowed_tools | No | Per §14.5 Tool allowlist — Absent | Missing |
| allowed_environments | No | No environment scope | Missing |
| max_budget (tokens, currency, wall_clock_minutes, retries) | No | Per §14.12 Budget per task/workflow — Absent | Missing |
| required_evidence | No | Per §14.9 Execution — Absent | Missing |
| rollback_expectation | Partial | `OpenSpec/openspec/specs/rules-injection/spec.md` line 32 injects `Include rollback plan` as prompt prose | Prose only |
| approval_requirements | Partial | `OpenSpec/openspec/specs/cli-archive/spec.md` "Confirmation Behavior" line 121 single Yes/No prompt, bypassable by `--yes` line 12 | Single non-tiered prompt |

**Task Card fields fully present:** 0/18 (six fields are Partial — folder-id, business-need-prose, acceptance-prose, out-of-scope-pattern, rollback-prose, single-prompt — none qualify as full structured presence).

#### Schema Coverage Score

Agent Card: 0/14 = 0%. Task Card: 0/18 = 0%. **Schema Coverage Score:** 0/100 — Severity per `prompt.md`: Critical.

### 14.19 Enterprise Guardrail Maturity Verdict

**Average domain coverage:** (18 + 20 + 32 + 10 + 12 + 18 + 14 + 15 + 22 + 15 + 15 + 12 + 15 + 15 + 22) / 15 = 255 / 15 = **17/100**
**§14.17 coverage:** 0/12 (0%)
**§14.18 schema coverage:** 0/100

**Verdict cascade application.** Average domain coverage 17 < 40 → triggers tier 1. §14.17 coverage 0% < 50% → triggers tier 1. Multiple non-negotiables score Critical (rows 1, 2, 3, 4, 5, 6, 8, 9, 10, 12) → triggers tier 1. First-match-wins: tier 1 applies.

`**Enterprise Guardrail Maturity: LACKING**`

**Highest-leverage single investment.** Introduce a per-change `change-card.json` artefact that combines `accountable_owner`, `risk_tier`, `data_classification`, `autonomy_tier` (1–4 per `manifesto-principles.md` lines 207–216), `allowed_tools`, `max_budget`, and `required_evidence` fields, persist it inside the change folder defined by `OpenSpec/openspec/specs/change-creation/spec.md`, and extend `OpenSpec/openspec/specs/cli-validate/spec.md` Zod schemas to refuse `openspec archive` when any field is missing or when the declared tier exceeds the cap stated in `domains/insurance.md` lines 263–268. This single artefact closes non-negotiables 1, 2, 3, 4, 8, 11 simultaneously and makes the rest enforceable. Effort: **L**. Allianz business workflow: SCR internal-model change governance under Solvency II Art. 112–127 (`domains/insurance.md` line 51) — the change-card binds an actuarial change to a named accountable owner, an autonomy cap of Tier 1 (observe only) per `domains/insurance.md` line 268, and the supervisory pre-approval evidence required by Solvency II major-change classification (`domains/insurance.md` line 86), without which the change cannot be archived.

**Boundary with Part 8.** Part 8 (Maturity Phase Placement) places OpenSpec on the AEM phase ladder. §14.19 reports a separate, orthogonal dimension: enterprise guardrail maturity. The two verdicts can disagree (e.g., a higher-phase framework with LACKING enterprise guardrails); they are not arbitrated here.

---

*Assessment prepared 2026-05-08. §14.1–§14.15 lifted verbatim from `_review_08a_domains.md`; §14.16–§14.19 produced by Agent 08b. All findings are based on static review of artefacts; dynamic enterprise-control testing was not performed.*
