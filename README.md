...
We are moving from writing software to architecting systems that write, test, and ship software under human direction. This manifesto defines the values, principles, and practices for doing so responsibly.
