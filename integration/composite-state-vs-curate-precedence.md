...
The minimum bar of IGM P5 (`intelligence-governance-manifesto/manifesto-principles.md:67`) — "Every claim has an expected validity window. Claims past their window trigger review alerts. Staleness metrics are tracked per domain." — is augmented:
