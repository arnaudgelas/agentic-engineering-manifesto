...
| Part 5 — Agentic Definition of Done | `_review_03_loop_dod.md` Part 5 | Split DoD from loop analysis. Preserve `#### DoD Condition Table` (4 columns × 8 rows), per-condition narratives, `#### DoD Hardening Test` (with literal closing sentence "Hardening is complete." or "Hardening is not complete."), `#### Industry-Specific DoD Requirements`. |
